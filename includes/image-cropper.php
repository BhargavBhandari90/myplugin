...
add_shortcode( 'bwp_uploader_live', 'bwp_uploader_callback_live' );

function bwp_uploader_callback_live() {

	blp_core_cover_image_scripts();
...
add_action( 'wp_ajax_bwp_crop_image_live', 'bwp_crop_image_live_callback' );

function bwp_crop_image_live_callback() {
